    ...
    <div className={styles.legalPage}>
      ...
      <div className={styles.legalSubNav}>
        <div className={styles.legalSubNavContent}>
          <span className={styles.legalBreadcrumb}>
            Legal <span className={styles.slash}>/</span> Terms of Use
          </span>
          <nav className={styles.legalNavLinks}>
            <Link href="/legal/privacy">Privacy</Link>
            <Link href="/legal/terms" className={styles.activeLink}>Terms of Use</Link>
      ...
      <div className={styles.legalContainer}>
        <header className={styles.legalHeader}>
          <span className={styles.legalEyebrow}>Quadra Software EULA</span>
          <h1 className={styles.legalTitle}>Terms of Use &amp; EULA</h1>
        ...
        <article className={styles.legalArticle}>
          ...
          <section className={styles.legalSection}>
            ...
            <p>
              Quadra provides a 90-day free trial of Hydra software for evaluation purposes. The trial software is provided full-featured with no channel limits or watermarks. Upon conclusion of the 90-day evaluation period, continued use of the software requires the purchase of a valid commercial license.
            </p>
          </section>
          ...
          <section className={styles.legalSection}>
            ...
            <p>
              You agree to comply with all applicable United States and international export laws and regulations, including the U.S. Export Administration Regulations (EAR). You represent that you are not located in any country subject to U.S. government embargoes or designated as a sanction-restricted party.
            </p>
          </section>

          <section className={styles.legalSection}>
            <h2>9. Contact Engineering Support</h2>
            <p>
              If you have questions regarding these Terms or licensing permissions, please contact us via <Link href="/support/contact">Quadra Support</Link>.
            </p>
          </section>
        </article>
      </div>
