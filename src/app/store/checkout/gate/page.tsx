    ...
    <div className={styles.page}>
      ...
      <div className={styles.container}>
        ...
        <div className={styles.columns}>
          ...
          {/* =========================================
             Left Column: Check out with your Quadra ID
             ========================================= */}
          ...
          {/* =========================================
             Right Column: Create a Quadra ID / Google Auth0 (Replacing Guest Checkout)
             ========================================= */}
          <div className={styles.column}>
            <h2 className={styles.colTitle}>Create a Quadra ID</h2>
            <p className={styles.colDesc}>
              Create an account to save your order, download licenses, and manage active Mac devices.
            </p>
            ...
            {!showSignUpForm ? (
              ...
              <form onSubmit={handleCreateAccountSubmit} className={styles.signUpForm}>
                ...
                <div className={styles.formGroup}>
                  <label htmlFor="gateRegName">Full Name</label>
                  <input
                    id="gateRegName"
                    type="text"
                ...
                <div className={styles.formGroup}>
                  <label htmlFor="gateRegEmail">Email Address</label>
                  <input
                    id="gateRegEmail"
                    type="email"
                ...
                {authProvider !== "google" && (
                  <div className={styles.formGroup}>
                    <label htmlFor="gateRegPassword">Password</label>
                    <input
                      id="gateRegPassword"
                      type="password"
                      placeholder="••••••••"
                ...
                <div className={styles.formGroup}>
                  <label htmlFor="gateRegStudio">Studio / Organization (Optional)</label>
                  <input
                    id="gateRegStudio"
                    type="text"
                ...
                <div className={styles.formGroup}>
                  <label htmlFor="gateRegCountry">Country / Region</label>
                  <select
                    id="gateRegCountry"
                    value={regCountry}
                ...
                <div className={styles.formGroup}>
                  <label htmlFor="gateRegPhone">Phone Number (Optional)</label>
                  <input
                    id="gateRegPhone"
                    type="tel"
