...
const sitemapData = [
  {
    ...
    links: [
      ...
      { label: "Hydra Overview", href: "/hydra", desc: "Virtual audio patchbay & Matrix Grid" },
      { label: "The Matrix Grid", href: "/hydra#tools", desc: "Bridges, process taps & VST3 hosting" },
      { label: "AES67 & NDI Network Audio", href: "/hydra#network", desc: "Multichannel Ethernet AoIP streaming" },
      { label: "Control Room Monitor", href: "/hydra#control-room", desc: "DIM, MONO, MUTE & TALKBACK MIC" },
      { label: "System Specifications", href: "/hydra#specs", desc: "macOS requirements & driver architecture" },
    ],
  },
  {
  ...
  },
  {
    ...
    links: [
      ...
      { label: "Configuring AES67 & NDI", href: "/support/article/configuring-ndi", desc: "Ethernet AoIP network setup guide" },
      ...
      { label: "Hardware ASRC Setup", href: "/support/article/hardware-asrc-setup", desc: "Physical device clock correction" },
      { label: "Control Room Monitor", href: "/support/article/control-room-monitor", desc: "Monitor control configuration" },
